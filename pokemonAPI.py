...
def post():
    ...
    if proba[0][0]>=proba[0][1]:
        win=str(round(proba[0][0]*100))+'%'+' '+str(nama2)+' '+'Wins!'
    else:
        win=str(round(proba[0][1]*100))+'%'+' '+str(nama1)+' '+'Wins!'
    ...
    plt.subplot(161)
    plt.bar(poke,pokehp,color=['yellow','orange'])
    plt.title('HP')
    i=0
    while i<len(poke):
    ...
    plt.subplot(162)
    plt.bar(poke,pokeatk,color=['yellow','orange'])
    plt.title('Attack')
    i=0
    while i<len(poke):
    ...
    plt.subplot(163)
    plt.bar(poke,pokedef,color=['yellow','orange'])
    plt.title('Defense')
    i=0
    while i<len(poke):
    ...
    plt.subplot(164)
    plt.bar(poke,pokespatk,color=['yellow','orange'])
    ...
    plt.subplot(165)
    plt.bar(poke,pokespdef,color=['yellow','orange'])
    ...
    plt.subplot(166)
    plt.bar(poke,pokespd,color=['yellow','orange'])
    plt.title('Speed')
    i=0
    while i<len(poke):
...
#     return render_template('upload.html', y=filebaru)
